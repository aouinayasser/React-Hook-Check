    ...
    return (
      <>
        ...
        <Modal show={show} onHide={handleClose}>
          ...
          <Modal.Body>
          <Form.Control type="text" placeholder="Title" value={title} onChange={(e) => setAddTitle(e.target.value)}/>
            <br />
            <Form.Group
              className="mb-3"
          ...
          <Modal.Footer>
            ...
            <Button variant="primary" onClick={()=>addInMovies({title,description,posterUrl,rating})}>
              Add this movie
            </Button>
          </Modal.Footer>
        </Modal>
